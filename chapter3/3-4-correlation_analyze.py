...
catering_sale = "F:\DeskTop\Python-Data\chapter3\demo\data\catering_sale_all.xls"
data = pd.read_excel(catering_sale,index_col="日期")

"""
默认为pearson相关系数，可以指定为kendall相关系数，spearman相关系数
D.corr(methon="pearson")
D.corr(methon="kendall")
D.corr(methon="spearman")
"""
R = data.corr()  #相关系数矩阵，即给出了任意两款菜式之间的相关系数
# print(R)
"""
...
"""
R1 = data.corr()["百合酱蒸凤爪"]  #只显示“百合酱蒸凤爪”与其他菜式的相关系数
# print(R1)
"""
百合酱蒸凤爪     1.000000
翡翠蒸香茜饺     0.009206
...
"""
R2 = data["百合酱蒸凤爪"].corr(data["翡翠蒸香茜饺"]) #计算“百合酱蒸凤爪”与“翡翠蒸香茜饺”的相关系数
print(R2)
"""
